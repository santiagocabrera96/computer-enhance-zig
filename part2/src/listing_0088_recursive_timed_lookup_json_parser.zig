...
const profiler = @import("./listing_0087_simplified_profiler.zig");
...
fn parseJsonList(allocator: Allocator, parser: *JsonParser, starting_token: JsonToken, end_type: JsonTokenType, has_labels: bool) Allocator.Error!*JsonElement {
    _ = starting_token;
...
fn parseJsonElement(allocator: Allocator, parser: *JsonParser, label: []const u8, value: JsonToken) Allocator.Error!?*JsonElement {
    ...
    switch (value.type) {
        .open_bracket => sub_element = try parseJsonList(allocator, parser, value, JsonTokenType.close_bracket, false),
        .open_brace => sub_element = try parseJsonList(allocator, parser, value, JsonTokenType.close_brace, true),
